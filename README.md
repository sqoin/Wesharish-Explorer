...
Our geniuses here at BastojiCorp™ have put together a script to do this for you. Just run

`bash script/wesharish_setup.sh`

This will install the latest wesharish wallet and create a rpc username/password before starting the daemon.

## Install
`git clone https://github.com/sqoin/Wesharish-Explorer.git` - copy repo to local folder.
