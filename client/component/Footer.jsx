      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            ...
            <div>WesharishCoin Explorer &copy; 2020 - {currentYear} <a href="http://explorer.weshareish.com/#/coin" target="_blank" rel="nofollow noopener">Wesharish Coin Cryptocurrency</a></div>
          </span>
        </div>
        <div className="footer__block">
